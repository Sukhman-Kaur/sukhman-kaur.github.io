...
export default function Skills() {
    ...
    return (
        <div className="skills container-fluid section" name="skills">
        <Fade bottom>
        ...
        <span className="badge badge-pill badge-light skill">PHP</span>
        <span className="badge badge-pill badge-light skill">Javascript</span>
        <span className="badge badge-pill badge-light skill">Laravel</span> 
        <span className="badge badge-pill badge-light skill">ReactJs</span>
        ...
        <span className="badge badge-pill badge-light skill">Agile</span> 
